...
//
//     final busListInfo = busListInfoFromJson(jsonString);

import 'dart:convert';

BusListInfo busListInfoFromJson(String str) =>
    BusListInfo.fromJson(json.decode(str));

String busListInfoToJson(BusListInfo data) => json.encode(data.toJson());
...
class BusListInfo {
  ...
  factory BusListInfo.fromJson(Map<String, dynamic> json) => BusListInfo(
...
class ResultDatum {
  ...
  String busJobInfoId;
  String docNo;
  dynamic carMileageStart;
  dynamic carMileageEnd;
